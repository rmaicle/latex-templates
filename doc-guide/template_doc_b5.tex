...
\usepackage[inner=0.5in,        % main inner margin
...
\usepackage{fontawesome5} % gives us nice monochrome icons
...
% Use the fontsize package constants to resize the terminal font
...
% Font size for a4 and us letter paper size
...
\setsecheadstyle{\fontsize{11pt}{15.6pt}\bfseries}
\setsubsecheadstyle{\fontsize{10pt}{14.4pt}\bfseries}
\setsubsubsecheadstyle{\fontsize{9pt}{13.2pt}\bfseries}
\titleformat{\paragraph}[block]{\fontsize{9pt}{12pt}\bfseries}{\theparagraph}{1em}{}
\titleformat{\subparagraph}[block]{\fontsize{9pt}{12pt}\bfseries\itshape}{}{0em}{}
