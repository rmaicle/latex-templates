...
\ifpdftex
    ...
    % Font size for a5 paper size
    % \usepackage[scaled=0.42]{helvet} % {phv}
    ...
    % Font size for a5 paper size
    % \usepackage[scaled=0.49]{beramono} % {fvm} default scaling is 0.9
...
%     left skip=\noteinfo@shift,
%     right skip=\noteinfo@shift,
%     overlay={\node[right] (noteinfonode) at ([xshift=-\noteinfo@shift]frame.west) {\textbf{Note:}} ;},
%     ]
%     #2
%   \end{tcolorbox}
%   \endgroup
...
% \newtcolorbox{noteinfo}[1][]{%
%   enhanced jigsaw,                      % better frame drawing
%   borderline west={3pt}{0pt}{red},      % straight vertical line at the left edge
%   sharp corners,                        % No rounded corners
%   boxrule=0pt,                          % no real frame,
%   fonttitle={\bfseries},
%   coltitle={black},                     % Black colour for title
%   title={Note:\quad \ },                     % Fixed title
%   attach title to upper,                % Move the title into the box
%   #1
% }

% https://tex.stackexchange.com/questions/657363/
\newtcolorbox[auto counter,number within=section]{noteinfo}[2][]{%
    borderline west={3pt}{0pt}{red},      % straight vertical line at the left edge
    coltitle=black,
    % title={{\bfseries Example~\thetcbcounter.}\quad#2},
    title={{\bfseries Note~}\quad#2},
    colback=black!5,
    colframe=black!10,
    coltext=green,
    #1
...
\newtcolorbox[auto counter,number within=section]{notedanger}[2][]{%
    borderline west={3pt}{0pt}{red},      % straight vertical line at the left edge
    coltitle=black,
    % title={{\bfseries Example~\thetcbcounter.}\quad#2},
    title={{\bfseries Information~}\quad#2},
    colback=black!5,
    colframe=black!10,
    coltext=red,
    #1
...
\newtcolorbox[auto counter,number within=section]{notewarning}[2][]{%
    borderline west={3pt}{0pt}{red},      % straight vertical line at the left edge
    coltitle=black,
    % title={{\bfseries Example~\thetcbcounter.}\quad#2},
    title={{\bfseries Information~}\quad#2},
