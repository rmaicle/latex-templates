...
$if(title)$
    ...
    \begin{flushright}
        ...
        $if(doctype)$
            {\normalsizerrr\textrm{$doctype$}}\\[0.2em]
        $endif$
        $if(version)$
            ...
            {\normalsizerrr\textrm{\ifoptiondraft{Draft}{}\space $version$}}\\[0.2em]
            % \vspace*{0.5em}
        $endif$
        {\normalsizerr\textrm{$date$}}\\[0.2em]
        \vspace*{1.75in}
        $if(author)$
            $if(author_heading)$
                {\normalsizerr\textrm{$author_heading$}}\\[1em]
            $endif$
            $for(author)$
                $if(author.name)$
                    \vspace*{1.4em}
                    ...
                    $if(author.title)$
                        {\normalsizerr\textrm{$author.title$}}\\[0.2em]
                    $endif$
                    $if(author.company)$
                        {\normalsizerr\textrm{$author.company$}}\\[0.2em]
                    $endif$
                    $if(author.email)$
                        {\normalsizerr\textrm{$author.email$}}\\
                    $endif$
                $endif$
            $endfor$
        $endif$
