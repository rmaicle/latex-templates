...
\else
    \usepackage{utopia}         % {put} taller and a bit wider than Bitstream Charter
    % \usepackage{tgpagella}    % {qpl} too elegant? for technical book/report
    % \usepackage{tgbonum}      % {qbk} wide
    % \usepackage{tgtermes}     % {qtm} narrow, looks like times
    % \usepackage{tgschola}     % {qcs} darker replacement for default serif
    %
    % Charter Note:
...
% \renewcommand*\rmdefault{qtm} % tgtermes
% \renewcommand*\rmdefault{qpl} % tgpagella
% \renewcommand*\rmdefault{qbk} % tgbonum
% \renewcommand*\rmdefault{qcs} % tgschola
...
\newcommand\TRMFontSize{\fontsize{10}{10}\selectfont}
\newcommand\LSTFontSize{\fontsize{10}{10}\selectfont}
...
\newcommand{\Note}[1]{%
    \ding{224}\enskip\textit{#1}
    % \ding{224}\space{\usefont{T1}{put}{rm}{it}\footnotesize{#1}}
}
...
$if(listings)$
    ...
    \lstdefinestyle{listingcommon}{
        ...
        numberstyle=\BeraMonofont\small\color{DimGray},
        basewidth=0.6em,
    }
    ...
    % but commenting out it out still produces an error.
    ...
    \providecommand{\texttt}[1]{\usefont{T1}{put}{rm}{b}{#1}}

$endif$



% Make lstinline use different font from lstlistings or lstinputlisting




% The following code was taken out of the listing conditional statement.
% Replaced by the caption formatting after which was taken from a project
% proposal document.
...
$if(is_softcopy)$
\DeclareCaptionFormat{listing}{\colorbox{Grey90}{\parbox{0.9342\textwidth}{#1#2#3}}}
\captionsetup[lstlisting]{
    format=listing,
    singlelinecheck=false,
    labelsep=quad,
...
$else$
\DeclareCaptionFormat{listing}{#1#2#3}
%\DeclareCaptionFormat{listing}{\colorbox{Grey90}{\parbox{0.9125\textwidth}{#1#2#3}}}
\captionsetup[lstlisting]{
    format=listing,
    singlelinecheck=false,
    labelsep=quad,
...
\setlength{\cftbeforesectionskip}{0.0em}
...
% -----------------------------------------------------------------------------
\fancypagestyle{main_pagestyle}{
\renewcommand{\headrulewidth}{0pt}
\renewcommand{\footrulewidth}{0.01pt}
\renewcommand{\footrule}{{\color{Gainsboro}%
\vskip-\footruleskip\vskip-\footrulewidth \hrule width\headwidth height\footrulewidth\vskip\footruleskip}}
\fancyhf{} % clear all header and footer fields
$if(short-title)$
    \lfoot[C]{\fontsize{9pt}{11pt}\usefont{T1}{put}{rm}{n}\selectfont $short-title$}
$else$
    \lfoot[C]{\fontsize{9pt}{11pt}\usefont{T1}{put}{rm}{n}\selectfont $title$}
$endif$
...
$if(title)$
    ...
    \begin{flushright}
        {
            {\fontsize{20pt}{26pt}\usefont{T1}{put}{b}{n}$title$\par}
            $if(subtitle)$
                \vspace*{0pt}
                {\fontsize{18pt}{24pt}\usefont{T1}{put}{m}{n}$subtitle$\par}
            $endif$
            $if(client)$
                {\fontsize{16pt}{20pt}\usefont{T1}{put}{m}{n}$client$\par}
            $endif$
        }

        \vspace*{0.4em}
        \noindent\textcolor{LightGray}{\rule{\textwidth}{1pt}}
        \vspace*{-0.3em}

        $if(type)$
            \vspace*{-0.4em}
            {\fontsize{16pt}{20pt}\usefont{T1}{put}{m}{n}$type$\par}
        $else$
            \vspace*{-0.0em}
        $endif$
        $if(version)$
            ...
            \vspace*{0.7em}
        $endif$
        {\fontsize{11pt}{13pt}\usefont{T1}{put}{m}{n}$date$}\\[0.05in]

        \vspace*{2.0in}
        $if(author)$
            $if(author_heading)$
                {\fontsize{12pt}{14pt}\usefont{T1}{put}{m}{n}$author_heading$}\\[1em]
            $endif$
            $for(author)$
                $if(author.name)$
                    {\fontsize{12pt}{14pt}\usefont{T1}{put}{b}{n}$author.name$}
                    $if(author.title)$
                        \\{\fontsize{11pt}{13pt}\usefont{T1}{put}{m}{n}$author.title$}
                    $endif$
                    $if(author.company)$
                        \\{\fontsize{11pt}{13pt}\usefont{T1}{put}{m}{n}$author.company$}
                    $endif$
                    $if(author.email)$
                        \\{\fontsize{11pt}{13pt}\usefont{T1}{put}{m}{n}$author.email$}
                        \vspace*{1.0em}
                    $endif$
                $endif$
            $endfor$
        ...
        \vspace{\fill}
        $if(distribution)$
            {\fontsize{10pt}{13pt}\usefont{T1}{put}{m}{n}$distribution$\par}
        $endif$
    \end{flushright}
$endif$
