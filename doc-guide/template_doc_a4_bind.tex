...
\usepackage[
        a4paper,
        inner=30mm,         % main inner margin
        outer=22mm,         % outer margin
        top=25mm,           % top margin
        bottom=25mm,        % bottom margin
        bindingoffset=10mm, % extra space for binding (gutter)
        footskip=0.4in,
...
$if(listings)$
    ...
    \ifpdftex
        ...
        \lst@AddToHook{TextStyle}{%
            ...
            \normalsizerr\usefont{T1}{zlmtt}{l}{n}\selectfont}
        \makeatother
    \fi
    \ifxetex
        \makeatletter
