...
$if(title)$
    ...
    \begin{flushright}
        {
            \ifpdftex
            {\fontsize{20pt}{26pt}\textbf{$title$}\par}
            \fi
            $if(subtitle)$
                \vspace*{0pt}
                \ifpdftex
                {\fontsize{18pt}{24pt}\textbf{$subtitle$}\par}
                \fi
            $endif$
            $if(client)$
                \ifpdftex
                {\fontsize{16pt}{20pt}\textrm{$client$}\par}
                \fi
            $endif$
        }
        ...
        $if(type)$
            \vspace*{-0.4em}
            \ifpdftex
            {\fontsize{16pt}{20pt}\textrm{$type$}\par}
            \fi
        $else$
            \vspace*{-0.0em}
        $endif$
        $if(version)$
            \ifpdftex
            {\fontsize{12pt}{14pt}
                \textrm{\ifoptiondraft{Draft}{}\space $version$}\\
        ...
        $endif$
        \ifpdftex
        {\fontsize{12pt}{14pt}\textrm{$date$}}\\[0.05in]
        \fi
        ...
        $if(author)$
            ...
            $for(author)$
                $if(author.name)$
                    \ifpdftex
                    {\fontsize{12pt}{14pt}\textbf{$author.name$}}
                    $if(author.title)$
                        \\{\fontsize{11pt}{13pt}\textrm{$author.title$}}
                    $endif$
                    $if(author.company)$
                        \\{\fontsize{11pt}{13pt}\textrm{$author.company$}}
                    $endif$
                    $if(author.email)$
        ...
        $if(distribution)$
            \ifpdftex
            {\fontsize{10pt}{13pt}\textrm{$distribution$}\par}
            \fi
        $endif$
    \end{flushright}
$endif$
