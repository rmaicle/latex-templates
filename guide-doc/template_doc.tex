...
% Make loose lists tighter
% ------------------------
% left 2.1em aligns with definition lists indented by 3em
\setlist[itemize]{topsep=1ex, itemsep=0mm, left=2.1em}
\setlist[enumerate]{topsep=1ex, itemsep=0mm, left=2.1em}
