...
\ifpdftex
    \newcommand{\TNote}[1]{%
        \ding{224}\space{\usefont{T1}{zlmtt}{rm}{it}\footnotesize{#1}}}
    \newcommand{\LNote}[1]{%
        \ding{224}\space{\usefont{T1}{fvm}{rm}{it}\footnotesize{#1}}}
    % Just an alias to LNote so we don't have to change the
    % source files now.
    \newcommand{\Note}[1]{%
        \ding{224}\space{\usefont{T1}{fvm}{rm}{it}\footnotesize{#1}}}
\fi
