...
$if(listings)$
    ...
    \newcommand\Small{\fontsize{10}{12}\selectfont}
    ...
    \lstset{
        ...
        % In two-column mode \parindent is always 1em based on Computer
        % Modern font. More info at the reference link:
        %   https://tex.stackexchange.com/questions/50138/
        %
        % The following value merely aligns the code listing (with line
        % numbers) to the left with the text paragraph.
        % xleftmargin=0.28in
        xleftmargin=17pt
    }
    $if(softcopy)$
    ...
    % Make lstinline use a differnt font size lstlistings or lstinputlisting
