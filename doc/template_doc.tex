...
\definecolor{GrayBackground}{RGB}{248,248,248}
...
\newcommand\TenPointSize{\fontsize{10}{10}\selectfont}

\newcommand*\CMDb{\usefont{T1}{lmtt}{b}{n}\TenPointSize\selectfont\SetTracking{encoding=*}{-12}\lsstyle}
\newcommand*\OUTb{\usefont{T1}{lmtt}{b}{n}\TenPointSize\selectfont\SetTracking{encoding=*}{-9}\lsstyle}
\newcommand*\LSTb{\usefont{T1}{fvm}{b}{n}\TenPointSize\selectfont\SetTracking{encoding=*}{-2}\lsstyle}

\newcommand*\CMDi{\usefont{T1}{lmtt}{m}{it}\TenPointSize\selectfont\SetTracking{encoding=*}{-18}\lsstyle}
\newcommand*\OUTi{\usefont{T1}{lmtt}{m}{it}\TenPointSize\selectfont\SetTracking{encoding=*}{-9}\lsstyle}
\newcommand*\LSTi{\usefont{T1}{fvm}{m}{it}\TenPointSize\selectfont\SetTracking{encoding=*}{-2}\lsstyle}

\newcommand*\CMDe{\usefont{T1}{lmtt}{b}{it}\TenPointSize\selectfont\SetTracking{encoding=*}{-18}\lsstyle}
\newcommand*\OUTe{\usefont{T1}{lmtt}{b}{it}\TenPointSize\selectfont\SetTracking{encoding=*}{-9}\lsstyle}
\newcommand*\LSTe{\usefont{T1}{fvm}{b}{it}\TenPointSize\selectfont\SetTracking{encoding=*}{-2}\lsstyle}
...
$if(listings)$
    ...
    % fontsize=10pt
    % basewidth=0.6em
    \newcommand*\BeraMonofont{\usefont{T1}{fvm}{m}{n}\TenPointSize\selectfont\SetTracking{encoding=*}{-60}\lsstyle}
    ...
    \newcommand*\LatinModernfont{\usefont{T1}{lmtt}{m}{n}\TenPointSize\selectfont\SetTracking{encoding=*}{-9}\lsstyle}
    ...
    \lstdefinestyle{default}{
        literate={-}{-}1,
        basicstyle=\LatinModernfont,
        keywordstyle=\LatinModernfont,
        stringstyle=\LatinModernfont,
        commentstyle=\LatinModernfont,
        numberstyle=\LatinModernfont\footnotesize\color{gray},
        basewidth=0.49em,
        lineskip=0pt,
        aboveskip=0.5em,
        belowskip=0em
    ...
    \lstset{
        ...
        % line numbers) to the left with the text ph body.
        % xleftmargin=0.28in
        xleftmargin=24pt,
        frame=none,
        escapechar=@
    ...
    \lstdefinestyle{syntax}{
        ...
        numberstyle=\BeraMonofont\footnotesize\color{gray},
        basewidth=0.6em,
        lineskip=1pt,
        aboveskip=0.5em,
        belowskip=0em
...
$if(softcopy)$
    %\DeclareCaptionFormat{listing}{\llap{#1#2}#3\par}
    \DeclareCaptionFormat{listing}{\colorbox{Gainsboro}{\parbox{0.9875\textwidth}{#1#2#3}}}
...
$else$
    \DeclareCaptionFormat{listing}{\hspace{24pt}#1#2#3}
    \captionsetup[lstlisting]{
        %labelformat=listing,
        format=listing,
...
\usepackage[perpage,hang,multiple]{footmisc}
...
% length=2.0in, rule thickness is 0.03pt and a vertical space of 2em between
% the rule and the first entry in the footnote
\renewcommand{\footnoterule}{\noindent\rule{2.5in}{0.03pt}\vspace{1em}}
...
\makechapterstyle{rmsimple}{
    ...
    \renewcommand*{\chapnumfont}{\fontsize{16pt}{19.2pt}\usefont{T1}{bch}{b}{n}}
    \renewcommand*{\chaptitlefont}{\fontsize{16pt}{19.2pt}\usefont{T1}{bch}{b}{n}}
...
\setsecheadstyle{\fontsize{15pt}{18pt}\usefont{T1}{bch}{b}{n}}
\setsubsecheadstyle{\fontsize{14pt}{16.8pt}\usefont{T1}{bch}{b}{n}}
\setsubsubsecheadstyle{\fontsize{13pt}{15.6pt}\usefont{T1}{bch}{b}{n}}
\titleformat{\paragraph}[block]{\fontsize{12pt}{14.4pt}\usefont{T1}{bch}{b}{n}}{\theparagraph}{1em}{}
\titleformat{\subparagraph}[block]{\fontsize{11pt}{13.2pt}\usefont{T1}{bch}{b}{n}}{}{0em}{}
