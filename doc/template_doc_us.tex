...
$if(listings)$
    ...
    \lstset{
        xleftmargin=8pt,            % move listing display to the right
        frame=single,
        frameround=tttt,
        framesep=2.5pt,
        framerule=0.1pt,
...
\makechapterstyle{negerns}{
    ...
    \renewcommand*{\printchapternum}{%
        \ifanappendix
            \chapnumfont \appendixname\space\thechapter\space\space\space\space%
        \else%
            \chapnumfont \thechapter\space\space\space\space%
        \fi%
    }
    \renewcommand*{\chapnumfont}{\fontsize{15pt}{1pt}\usefont{T1}{bch}{b}{n}}
    \renewcommand*{\chaptitlefont}{\fontsize{15pt}{1pt}\usefont{T1}{bch}{b}{n}}
...
\setsecheadstyle{\fontsize{14pt}{1pt}\usefont{T1}{bch}{b}{n}}
\setsubsecheadstyle{\fontsize{13pt}{1pt}\usefont{T1}{bch}{b}{n}}
\setsubsubsecheadstyle{\fontsize{12pt}{1pt}\usefont{T1}{bch}{b}{n}}
